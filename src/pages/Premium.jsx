    ...
    <PremiumLayout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center">
          <p className="text-orange-700 text-base font-semibold mb-3">Features</p>
              ...
              <div className="flex justify-between relative z-10">
                ...
                <div className="w-80 flex flex-col items-center">
                  ...
                  <div className="flex flex-col items-center">
                    <span className={`text-sm font-semibold ${currentStep === 1 ? 'text-orange-700' : 'text-slate-700'}`}>
                      Daten hochladen
                    </span>
                    <span className={`text-sm ${currentStep === 1 ? 'text-orange-500' : 'text-slate-600'}`}>
                ...
                <div className="w-80 flex flex-col items-center">
                  ...
                  <div className="flex flex-col items-center">
                    <span className={`text-sm font-semibold ${currentStep === 2 ? 'text-orange-700' : 'text-slate-700'}`}>
                      Stil einstellen
                    </span>
                    <span className={`text-sm ${currentStep === 2 ? 'text-orange-500' : 'text-slate-600'}`}>
                ...
                <div className="w-80 flex flex-col items-center">
                  ...
                  <div className="flex flex-col items-center">
                    <span className={`text-sm font-semibold ${currentStep === 3 ? 'text-orange-700' : 'text-slate-700'}`}>
                      Dateien herunterladen
                    </span>
                    <span className={`text-sm ${currentStep === 3 ? 'text-orange-500' : 'text-slate-600'}`}>
